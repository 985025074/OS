...
pub struct Pipe {
    readable: bool,
    writable: bool,
    buffer: Arc<RefCellSafe<PipeRingBuffer>>,
}

impl Pipe {
    pub fn read_end_with_buffer(buffer: Arc<RefCellSafe<PipeRingBuffer>>) -> Self {
        Self {
            readable: true,
            writable: false,
            buffer,
    ...
    pub fn write_end_with_buffer(buffer: Arc<RefCellSafe<PipeRingBuffer>>) -> Self {
        Self {
            readable: false,
            writable: true,
            buffer,
...
pub fn make_pipe() -> (Arc<Pipe>, Arc<Pipe>) {
    let buffer = Arc::new(RefCellSafe::new(PipeRingBuffer::new()));
